...
export declare class WebviewPlugin extends PluginConnector {
    private listeners;
    panel?: WebviewPanel;
...
/** Create a webview */
export declare function createWebview(profile: Profile, url: string, options: WebviewOptions): WebviewPanel;
export {};
